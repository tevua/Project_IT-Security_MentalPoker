...
public class NetworkTest {
	...
	public static void createCerts() {
		try {
			...
			genSelfSigned1.createRoot(new X500Name("C=GERMANY,L=Wedel,O=FH Wedel, OU=ITSProject WS1516, CN=Charles"), 2048,
					CHARLES, PASSWORD_KEY, "charles");

			X509CertGenerator genSelfSigned2 = new X509CertGenerator(new BigInteger("9"));
			genSelfSigned2.createRoot(new X500Name("C=GERMANY,L=Wedel,O=FH Wedel, OU=ITSProject WS1516, CN=DAISY"), 2048, DAISY,
					PASSWORD_KEY, "daisy");
